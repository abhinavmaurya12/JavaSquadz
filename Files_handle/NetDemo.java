...
protected void commandControl(KeyEvent ke) {
	...
	if (c=='\n'){
		...
		////////////////// URL INFORMATION //////////////////////
		else if (commandEnter.startsWith("urlinfo") || commandEnter.startsWith("urlinfo "))
		{
		ta.setEditable(true);
		ta.append(commandEnter+"\n");
		ta.setEditable(false);
        ...
        ta.setEditable(false);
            ...
            else if (commandEnter.equalsIgnoreCase("help") || commandEnter.equalsIgnoreCase("?"))
            {
                ...
                ta.append("  edit     | Goes to Edit Mode         | edit filenames(optional)\n");
                ta.append("  find     | Finds file                | find prog.dbm hello.txt \n");
                ta.append("  kill     | Deletes file              | kill file1.txt file2.tat\n");
                ...
                ta.append("  ren      | Rename files              | ren oldDemo.txt newName.txt\n");
            ...
            String temp4=st.hasMoreTokens()?st.nextToken():"";
            temp2=temp3+temp4;
            ...
            ta.append("Error: Command requires an argument\n");
            ta.append(currentPath+prompt);
            ta.setEditable(false);
            tf.requestFocus();
            }
