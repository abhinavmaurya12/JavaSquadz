...
public class NetDemo extends Panel implements KeyListener 
{
    ...
    if (c=='\n'){
        ...
        tempCommand=tempCommand+1;
        //System.out.println(l1+" "+commandNum);
        }
        ...
        //ta.setText("");
        editOn=true;
        myFrame.setTitle("Molecule (NetDemo Console) - Edit Mode (Type 'exit' to quit) - "+currentFile);
        ta.requestFocus();
        ...
        ta.append(" local      | Shows country Time & Date | local -us\n");
